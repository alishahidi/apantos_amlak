                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <fieldset class="form-group">
                                    ...
                                    <input value="<?= e(oldOr("title", $slide->title)) ?>" name="title" type="text" id="title" class="form-control <?= errorClass("title") ?>" placeholder="عنوان ...">
                                    <?= errorText("title") ?>
                                </fieldset>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    <input value="<?= e(oldOr("url", $slide->url)) ?>" name="url" type="text" id="url" class="form-control <?= errorClass("url") ?>" placeholder="لینک ...">
                                    <?= errorText("url") ?>
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    <input value="<?= e(oldOr("amount", $slide->amount)) ?>" name="amount" type="text" id="amount" class="form-control <?= errorClass("amount") ?>" placeholder="مبلغ ...">
                                    <?= errorText("amount") ?>
                                </fieldset>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <fieldset class="form-group">
                                    ...
                                    <input value="<?= e(oldOr("address", $slide->address)) ?>" name="address" type="text" id="address" class="form-control <?= errorClass("address") ?>" placeholder="آدرس ...">
                                    <?= errorText("address") ?>
                                </fieldset>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    <section class="col-md-12 d-flex justify-content-center">
                                        <img id="image" src="<?= oldOr("image", $slide->image) ?>" class="image-preview-md">
                                    </section>
                                </fieldset>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <textarea name="body" class="<?= errorClass("body") ?>" id="body"><?= d(oldOr("body", $slide->body)) ?></textarea>
                                    <?= errorText("body") ?>
                                </fieldset>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <section class="form-group">
                                    <button type="submit" class="btn btn-outline-dark mt-4">ویرایش اسلاید</button>
                                </section>
                            </div>
                        </div>
                    </form>
